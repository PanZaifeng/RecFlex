...
def plot_bars(data_list, fontsize=18, save="kern.pdf"):
    ...
    plt.legend(bbox_to_anchor=(0.47, 1.05), loc="lower center", ncol=4,
               fontsize=fontsize - 2, handletextpad=0.5, columnspacing=2,
               frameon=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="kern_ABC.pdf")
