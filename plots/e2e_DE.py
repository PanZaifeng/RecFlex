...
def plot_bars(data_list, fontsize=22, save="e2e.pdf"):
    models = ["D", "E"]
    labels = ["TF", "TF-RECom", "TorchRec", "HugeCTR (w/o cache)", "RecFlex"]
    ...
    plt.legend(bbox_to_anchor=(0.45, 1.1), loc="lower center", ncol=3,
